...
export default function FlippyClocky() {
  useEffect(() => {
    const prevTitle = document.title;
    document.title = "FlippyClocky · Just Fun · Tanner Wuster";
        ...
        <div className="wrapper justforfun-page__wrap">
          ...
          <header className="justforfun-page__masthead">
            <h1 className="justforfun-page__title">
              <span className="justforfun-page__title-mark">FlippyClocky</span>
            </h1>
            <p className="justforfun-page__tagline">
              A tiny flip-clock experiment for maximal satisfaction.
            </p>
          </header>
